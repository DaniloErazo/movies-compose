...
import com.globant.presentation.theme.MediumGray
...
fun SignIn(navController: NavController, viewModel: LoginViewModel = hiltViewModel()){
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Text(text = "¿Olvidaste tu contraseña?", fontStyle = FontStyle.Italic, color = DarkGray)
...
fun Button(text: String, enabled: Boolean, onClick: () -> Unit){
    Button(onClick = { onClick() },
        ...
        shape = RoundedCornerShape(10.dp),
        colors = ButtonDefaults.buttonColors(containerColor = Grey, disabledContainerColor = MediumGray)
    ) {
        Text(text = text,
            fontSize = 20.sp,
            color = Color.White,
