package com.globant.imdb2.data.network.services
...
interface MovieServices {
    ...
    @GET("movie/popular")
    suspend fun getTopMovies(@Query("api_key") apiKey: String = "749058a6469a1eb756bd200fa7ebb58e"): Response<MovieResponse>
