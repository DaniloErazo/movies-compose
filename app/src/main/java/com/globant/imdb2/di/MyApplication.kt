...
class CustomWorkerFactory @Inject constructor(private val api: MovieServices, private val movieDao: MovieDao): WorkerFactory(){
    override fun createWorker(
        appContext: Context,
        workerClassName: String,
        workerParameters: WorkerParameters
    ): ListenableWorker = GetMoviesWorker(appContext, workerParameters, api, movieDao)
